...
import { Link } from "react-router-dom";// <link to="/"></link> is used to divert to particular route
import { FaBackward } from "react-icons/fa";//icon for back key
import EmployeeForm from "../components/EmployeeForm";//to embed emplyee form
